...
class EmailMonitor:
    def __init__(self, check_interval_minutes: int = 5):
        ...
        self.db = Database()
        self.printer = PrinterService(fallback_to_file=True)
            ...
            if has_task:
                ...
                if mission_id:
                    ...
                    if success:
                        ...
                        logger.warning(f"⚠️ Print failed for mission: {mission_id}")
                ...
                logger.info(f"No actionable task found in email")
            
            # Mark email as processed
            self.db.mark_email_processed(email_data, has_task=has_task)
            return True
